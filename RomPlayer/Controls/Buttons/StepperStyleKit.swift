...
public class StepperStyleKit : NSObject {
    ...
    @objc dynamic public class func drawStepper(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 109, height: 37), resizing: ResizingBehavior = .aspectFit, valuePressed: CGFloat = 0, text: String = "1") {
        ...
        let buttonBack = UIColor(red: 0.243, green: 0.243, blue: 0.263, alpha: 1.000)
        ...
        //// Button
        //// buttonMinus Drawing
        let buttonMinusPath = UIBezierPath(roundedRect: CGRect(x: 0.5, y: 2, width: 35, height: 32), cornerRadius: 1)
        downSeleted.setFill()
        buttonMinusPath.fill()
        UIColor.black.setStroke()
        buttonMinusPath.lineWidth = 1
        buttonMinusPath.stroke()


        //// buttonPlus Drawing
        let buttonPlusPath = UIBezierPath(roundedRect: CGRect(x: 70.5, y: 2, width: 35, height: 32), cornerRadius: 1)
        upSelected.setFill()
        buttonPlusPath.fill()
        UIColor.black.setStroke()
        buttonPlusPath.lineWidth = 1
        buttonPlusPath.stroke()


        //// background Drawing
        let backgroundRect = CGRect(x: 35.5, y: 2, width: 35, height: 32)
        ...
        let backgroundFontAttributes = [
            NSAttributedString.Key.font: UIFont(name: "AvenirNextCondensed-Regular", size: UIFont.systemFontSize)!,
            NSAttributedString.Key.foregroundColor: textColor,
            NSAttributedString.Key.paragraphStyle: backgroundStyle,
        ]
        ...
        //// Rectangle Drawing
        context.saveGState()
        context.translateBy(x: 89.5, y: 18)
